...
class Transformer(nn.Module):
    def __init__(self, model_name_or_path: str,config=None, max_seq_length: Optional[int] = None,
        ...
        assert model_name_or_path, "Initializing the model requires a model name or path"
        self.config = AutoConfig.from_pretrained(model_name_or_path) if not config else config
